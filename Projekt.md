...
- [ ] **Hintergrundfarbe** des Spielfelds zum neuen Kartenlook abstimmen
      (aktuell `#1B5E20` in style.css, body) — schnelle Einzeländerung.
- [ ] **Menü-Overlay mit Schieberegler** (Idee des Nutzers): Hintergrund-
      Helligkeit/Farbe oder Farb-Themes. Als Politur-Schritt NACH der Hintergrundfarbe.
