...
8. [ ] `endgame.js` (Modul 15 + 16 + 17) — LETZTER SCHRITT.
       ACHTUNG: Modul 16 enthält die Initialisierung (Spielstart-Aufruf,
       DOMContentLoaded o.ä.). Hier besonders auf Top-Level-Ausführung und
       Lade-Reihenfolge achten – dieser Teil MUSS ggf. NACH allem anderen laufen.
