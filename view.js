...
function handleCardSelect(event) {
  ...
  // Klick auf Karte im EIGENEN Ablagestapel → wenn bereits eine Karte gewählt ist,
  // als Ablege-Ziel behandeln. So wird der Stapel auch dann erkannt, wenn schon
  // Karten darin liegen (nicht nur am leeren unteren Rand). Ohne Auswahl geht es
  // normal weiter, damit die oberste Ablagekarte weiterhin als Quelle wählbar ist.
  if (selectedCard && event.currentTarget.closest('.human-area .discard-field')) {
